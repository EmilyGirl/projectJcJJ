	...
	<div id="mine" class="mine">
		...
		<div class="log_banner ml_block" v-if="getxxx()">
			<router-link :to="{name:'personal_data',}" tag='div' class="top">
				<var><img src="../../../assets/img/wechat/mineJ/nav_touxiang.png" class="user_header" /><span class="last_time">上次登录8月10日&nbsp;13:35</span></var>
			...
			<ul>
				<li class="ml_block_list">
					...
					<div class="name">
						...
						<p class="keyong"  v-if="getxxx()">{{(obj.leftMoney/100) | toCurrencyString}}</p>
		...
		<section id="ml_block4" class="ml_block ml_block4">
			<ul>
				<router-link to="/app_terminal/message_list" tag="li" class="ml_block_list">
					<div class="name">
						我的消息
					</div>
					<div>
		...
		<section id="ml_block5" class="ml_block ml_block5">
			<ul>
				...
				<li  class="ml_block_list" @click="toEvaluate">
					<div class="name">
						风险评测
					</div>
					<div>
				...
				<!--<router-link to="/wechat/disclosure/evaluate" tag="li" class="ml_block_list"></router-link>-->
...
//				}
			...
			toEvaluate(){
				if(this.obj.appraisalResultStatus=='1'){
					this.$router.push({
