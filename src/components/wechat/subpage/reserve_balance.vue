<template>
    <div id="reserve_balance" class="reserve_balance">
        ...
        <p class="legend">
            ...
            <span>
                <i style="background: #72B6FF;"></i>冻结中金额</span>
        </p>
        <section id="ml_block1" class="ml_block ml_block1">
            <ul>
                <li class="ml_block_list" v-if='!isHistory'>
                    ...
                    <div>
                        <span class="zichan">{{(phone/100).toFixed(2)}}</span>元
                    </div>
                </li>
                <li class="ml_block_list">
                    ...
                    <div @click="goZeek_rewards1">
                        {{(log_pwd/100).toFixed(2)}}元
    ...
    this.$http
      ...
      .then(data => {
        this.chartsData = [
          ...
          {
            value: data.data.obj.log_pwd,
            name: "待收收益"
          },
          {
            value: data.data.obj.principalCost,
            name: "待收本金"
          },
          {
            value: data.data.obj.purchaseCost,
            name: "冻结中金额"
          }
        ];
        // awardAllMoney
        ...
        this.couponNum = data.data.obj.couponNum; //理财券个数
        this.redBagNum = data.data.obj.redBagNum; //红包个数
        this.couponcounts = data.data.obj.couponcounts;
        this.lijinNum = this.couponcounts - this.redBagNum - this.couponNum;
        // 申购中
        this.purchaseCost = data.data.obj.purchaseCost;
        // 待收本金
        this.principalCost = data.data.obj.principalCost;
        
        this.interestCost = data.data.obj.interestCost;
        this.initChart();
      });
  },
  methods: {
