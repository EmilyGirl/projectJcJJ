  ...
  <div class="product-detail">
      ...
      <div class="page1" @touchstart="touchstartLi" @touchmove='touchmoveLi("page1",$event)' @touchend="touchendLi" v-show='page1'>
        ...
        <div class="product-header">
          <p class="interest">
            ...
            <var class="yuan-mum" v-if="isJiangLi != '1'">%</var>
        ...
        <div class="calculator">
          <div class="calculator-content">
            ...
            <div class="calculator-common clearfix" style="border:none">
              ...
              <!-- <span style="font-size:1.5rem">   {{message* (parseFloat(baseEarnings) +parseFloat(jiangLiEarnings))*tzqx/(365*100)}}</span> -->
           
              <p class="fr">{{message* (parseFloat(baseEarnings) +parseFloat(jiangLiEarnings))*tzqx/(365*100) | fixNum1 }}元</p>
            </div>
        ...
        <div class="algorithm">
          ...
          <div class="prodDesc">
            ...
            <p>起息时间
              <span class="resdata">T+{{daytime}},募集成功{{daytime ? "次日" : "当日"}}计算 </span>
            </p>
            <p>募集周期
    ...
    <div class="bang-mask" style="z-index:101" v-if="relieveBang">
      <div class="bang-content" style="height:20rem">
        <p class="bang-title">提示</p>
        <p class="bang-common">您的银行卡解绑流程尚未完成</p>
      ...
      _this.$http
        ...
        .then(function(res) {
          if (res.data.end == "ok") {
            ...
            // console.log(
            //   2000 *
            //     (parseFloat(_this.baseEarnings) +
            //       parseFloat(_this.jiangLiEarnings)) *
            //     _this.tzqx /
            //     (365 * 100)
            // );
            // 产品类型
        ...
        if (_this.info == "请先充值") {
          ...
          _this.checkCode({
            ...
            query: {
              ...
              productMessage: encodeURIComponent(JSON.stringify(this.item)),
