...
<script>
	...
	export default {
		...
		created: function() {
			var _this = this;
			_this.phone = _this.$decryptByDES(_this.$getCookie(usernameName), _this.$uncompile(usernameKey)).substring(0,3)
						+'****'+_this.$decryptByDES(_this.$getCookie(usernameName), _this.$uncompile(usernameKey)).substring(7);
			var isBindBank;
			var isPayPwd;
