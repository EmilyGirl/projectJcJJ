      ...
      <!--  银行卡  购买 -->
		...
		<div class="preject">
			<ul class="qixian">
              ...
              <!-- 现金卡 -->
              <span    class="mainC" v-if="(this.r != null ? 1 : ((this.c != null || this.ra != null)? 0: (jialitype == '2' || jialitype == '3'))) && state == 'ok' && parseInt(message)/100 >= 1">{{(message*(parseFloat(baseEarnings) +parseFloat(jiangLiEarnings))*tzqx/(365*100))|fixNum1}}</span>
						<!-- 加息券 -->
