...
const account_success = resolve => require(['@/components/wechat/subpage/account_success'], resolve)
const card_dispose = resolve => require(['@/components/wechat/subpage/card_dispose'], resolve)
...
const record_detail = resolve => require(['@/components/wechat/subpage/record_detail'], resolve)
...
const details = resolve => require(['@/components/wechat/subpage/details'], resolve)
const record = resolve => require(['@/components/wechat/subpage/record'], resolve)
...
const evaluate = resolve => require(['@/components/wechat/disclosure/evaluate'], resolve)
const evaluate_result = resolve => require(['@/components/wechat/disclosure/evaluate_result'], resolve)
const aboutCG =  resolve => require(['@/components/app_terminal/aboutCG'], resolve)

// 首页   可移动的
const index = resolve => require(['@/components/wechat/homepage/index'], resolve)
//首页  可移动的
...
const OLDLEGACY = [{
	...
	//首页  可移动的
	{
		...
		children: [{
			...
			{
				path: '/wechat/subpage/product', //集财主页面
				meta: {
					title: '集财',
					noRequireAuth: true
				},
...

 {
	...
	// }, 
	{
		...
		path: '/wechat/subpage/card_dispose', //解绑卡申请处理中
		name: 'card_dispose',
		meta: {
			title: '集财'
		},
		component: card_dispose,
	}, {
		path: '/wechat/subpage/account_success', //开户成功
		...
		path: '/wechat/subpage/bind_bank', //绑定银行卡  存管开户
		name: 'bind_bank',
		meta: {
			title: '集财'
		},
		...
		path: '/wechat/subpage/record_detail', //投资详情
		name: 'record_detail',
		meta: {
			title: '集财'
		},
		...
		path: '/wechat/subpage/details', //详情
		name: 'details',
		meta: {
			title: '详情'
		},
		...
		path: '/wechat/subpage/record', //信息列表出借记录
		name: 'record',
		meta: {
			title: '详情'
		},
	...
	{
		path: '/wechat/disclosure/evaluate_result',
